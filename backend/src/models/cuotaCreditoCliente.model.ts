...
export interface CuotaCreditoClienteAttributes {
  id: bigint;
  fechaProgramadaPagoCuotaCreditoCliente?: Date|null;
  creditoClienteId: number;
  montoCuotaCreditoCliente: number;
  pagoCuotaCreditoClienteId?: bigint | null;
  createdAt?: Date;
  updatedAt?: Date;
}

export interface CuotaCreditoClienteCreationAttributes
  extends Optional<
    CuotaCreditoClienteAttributes,
    "id" | "fechaProgramadaPagoCuotaCreditoCliente" | "pagoCuotaCreditoClienteId" | "createdAt" | "updatedAt"
  > {}
